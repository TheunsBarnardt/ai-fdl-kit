...
| **YAML Source** | [View on GitHub](https://github.com/TheunsBarnardt/claude-fdl/blob/master/blueprints/data/caching.blueprint.yaml) |
| **JSON API** | [caching.json]({{ site.baseurl }}/api/blueprints/data/caching.json) |
