...
- **body_length** *(number, required)*
- **msg_type** *(text, required)*
- **sender_comp_id** *(text, required)*
- **target_comp_id** *(text, required)*
- **msg_seq_num** *(number, required)*
- **sending_time** *(datetime, required)*
- **orig_sending_time** *(datetime, optional)*
- **poss_dup_flag** *(boolean, optional)*
- **poss_resend** *(boolean, optional)*
- **checksum** *(text, required)*
- **appl_ver_id** *(text, optional)*
