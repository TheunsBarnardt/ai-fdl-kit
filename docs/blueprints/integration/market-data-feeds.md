...
| **YAML Source** | [View on GitHub](https://github.com/TheunsBarnardt/claude-fdl/blob/master/blueprints/integration/market-data-feeds.blueprint.yaml) |
| **JSON API** | [market-data-feeds.json]({{ site.baseurl }}/api/blueprints/integration/market-data-feeds.json) |
