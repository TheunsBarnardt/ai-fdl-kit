...
- **Apply Putaway Rule** — when incoming stock receipt has putaway rules defined for the item; at least one target warehouse has available capacity, then Incoming stock automatically distributed to warehouses per putaway rules.
