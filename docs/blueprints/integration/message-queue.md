...
| **YAML Source** | [View on GitHub](https://github.com/TheunsBarnardt/claude-fdl/blob/master/blueprints/integration/message-queue.blueprint.yaml) |
| **JSON API** | [message-queue.json]({{ site.baseurl }}/api/blueprints/integration/message-queue.json) |
