...
- **Gift Card Redeemed** — when customer enters a gift card code; gift card has sufficient remaining balance, then Gift card balance applied as payment toward the order.
