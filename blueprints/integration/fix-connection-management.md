...
- **connection_type** *(select, required)*
- **socket_accept_port** *(number, optional)*
- **socket_connect_host** *(text, optional)*
- **socket_connect_port** *(number, optional)*
- **socket_connect_source_host** *(text, optional)*
- **socket_connect_source_port** *(number, optional)*
- **reconnect_interval** *(number, optional)*
- **socket_nodelay** *(boolean, optional)*
- **socket_send_buffer_size** *(number, optional)*
- **socket_receive_buffer_size** *(number, optional)*
- **socket_reuse_address** *(boolean, optional)*
- **host_selection_policy** *(select, optional)*
- **ssl_certificate** *(text, optional)*
- **ssl_private_key** *(text, optional)*
- **ssl_ca_certificate** *(text, optional)*
