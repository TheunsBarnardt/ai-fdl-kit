...
| **YAML Source** | [View on GitHub](https://github.com/TheunsBarnardt/claude-fdl/blob/master/blueprints/access/audit-logging.blueprint.yaml) |
| **JSON API** | [audit-logging.json]({{ site.baseurl }}/api/blueprints/access/audit-logging.json) |
