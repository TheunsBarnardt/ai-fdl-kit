...
- **Message Sent** — when platform API accepted message, then Message delivered to platform.
- **Rate Limit Handling** — when platform returned 429 or rate limit header, then Message queued with exponential backoff, will retry.
