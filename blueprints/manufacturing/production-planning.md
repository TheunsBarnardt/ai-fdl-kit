...
- **Fetch Sales Orders** — when get_items_from eq "sales_order"; user applies filters for date range, customer, or item group, then Sales orders matching the filter criteria are loaded into the plan.
