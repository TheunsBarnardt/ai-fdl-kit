...
- **validate_length_and_checksum** *(boolean, optional)*
- **validate_fields_out_of_order** *(boolean, optional)*
- **validate_fields_have_values** *(boolean, optional)*
- **validate_user_defined_fields** *(boolean, optional)*
- **allow_unknown_msg_fields** *(boolean, optional)*
- **data_dictionary_path** *(text, optional)*
- **transport_data_dictionary_path** *(text, optional)*
- **app_data_dictionary_path** *(text, optional)*
- **begin_string** *(text, required)*
