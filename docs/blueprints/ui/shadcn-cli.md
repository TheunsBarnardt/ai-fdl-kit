...
| **JSON API** | [shadcn-cli.json]({{ site.baseurl }}/api/blueprints/ui/shadcn-cli.json) |
...
| `cli` | shadcn CLI | system | The CLI tool that orchestrates component installation |
