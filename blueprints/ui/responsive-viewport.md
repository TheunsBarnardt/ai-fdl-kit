...
- **Style Sync Update** — when a stylesheet changes in the parent document; iframe rendering is active, then Iframe preview reflects latest parent styles without reload. *(error: `STYLE_SYNC_FAILED`)*
