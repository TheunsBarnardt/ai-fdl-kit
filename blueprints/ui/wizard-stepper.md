...
- **Wizard Resumed** — when user returns to a wizard with saved progress; save_state_id exists and contains valid data, then Wizard resumes at the last saved step with all data intact. *(error: `WIZARD_RESUME_EXPIRED`)*
