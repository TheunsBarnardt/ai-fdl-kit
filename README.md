...
_Last run: 2026-04-12 — 46 blueprints below the fitness threshold. Pick a row, paste the command into Claude Code, and `/fdl-auto-evolve` will re-score after extraction._
...
### 🔴 notification/device-alarm-notifications — 62/100
...
### 🔴 workflow/maintenance-reminders — 62/100
**Weakest dimension:** `agi` (0/5)

_No candidates mapped for `workflow` + `agi`. Run `/fdl-recommend-discover maintenance-reminders` to find some._

### 🔴 asset/trip-replay — 63/100
**Weakest dimension:** `agi` (0/5)

_No candidates mapped for `asset` + `agi`. Run `/fdl-recommend-discover trip-replay` to find some._
...
### 🔴 data/fuel-level-reporting — 63/100
**Weakest dimension:** `agi` (0/5)
...
### 🔴 asset/location-visit-history — 64/100
**Weakest dimension:** `agi` (0/5)

_No candidates mapped for `asset` + `agi`. Run `/fdl-recommend-discover location-visit-history` to find some._

### 🔴 data/driver-identification — 64/100
**Weakest dimension:** `agi` (0/5)
...
### 🔴 asset/vehicle-efficiency-metrics — 66/100
**Weakest dimension:** `agi` (0/5)

_No candidates mapped for `asset` + `agi`. Run `/fdl-recommend-discover vehicle-efficiency-metrics` to find some._

### 🔴 data/engine-hours-tracking — 66/100
**Weakest dimension:** `agi` (0/5)
...
### 🔴 notification/geofence-alerts — 66/100
**Weakest dimension:** `agi` (0/5)
...
### 🔴 asset/trip-energy-consumption — 67/100
**Weakest dimension:** `agi` (0/5)

_No candidates mapped for `asset` + `agi`. Run `/fdl-recommend-discover trip-energy-consumption` to find some._

### 🔴 asset/vehicle-sleep-wake-detection — 67/100
**Weakest dimension:** `agi` (0/5)

_No candidates mapped for `asset` + `agi`. Run `/fdl-recommend-discover vehicle-sleep-wake-detection` to find some._

### 🔴 asset/vehicle-state-machine — 67/100
**Weakest dimension:** `agi` (0/5)

_No candidates mapped for `asset` + `agi`. Run `/fdl-recommend-discover vehicle-state-machine` to find some._
...
### 🔴 data/device-status-tracking — 68/100
**Weakest dimension:** `agi` (0/5)
...
### 🔴 notification/overspeed-alerts — 68/100
**Weakest dimension:** `agi` (0/5)
...
### 🔴 workflow/trip-detection — 68/100
**Weakest dimension:** `agi` (0/5)

_No candidates mapped for `workflow` + `agi`. Run `/fdl-recommend-discover trip-detection` to find some._

### 🔴 workflow/workshop-directory — 68/100
**Weakest dimension:** `agi` (0/5)

_No candidates mapped for `workflow` + `agi`. Run `/fdl-recommend-discover workshop-directory` to find some._

### 🔴 asset/ev-charging-session — 69/100
**Weakest dimension:** `agi` (0/5)

_No candidates mapped for `asset` + `agi`. Run `/fdl-recommend-discover ev-charging-session` to find some._

### 🔴 data/ignition-detection — 69/100
**Weakest dimension:** `agi` (0/5)
...
### 🔴 notification/vehicle-renewal-reminders — 69/100
**Weakest dimension:** `agi` (0/5)

_No candidates mapped for `notification` + `agi`. Run `/fdl-recommend-discover vehicle-renewal-reminders` to find some._

### 🔴 workflow/order-sla-eta — 69/100
**Weakest dimension:** `agi` (0/5)

_No candidates mapped for `workflow` + `agi`. Run `/fdl-recommend-discover order-sla-eta` to find some._

### 🔴 access/fleet-device-sharing — 71/100
**Weakest dimension:** `agi` (0/5)
...
### 🔴 integration/remote-device-commands — 72/100
**Weakest dimension:** `agi` (0/5)
