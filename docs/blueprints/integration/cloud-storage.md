...
| **YAML Source** | [View on GitHub](https://github.com/TheunsBarnardt/claude-fdl/blob/master/blueprints/integration/cloud-storage.blueprint.yaml) |
| **JSON API** | [cloud-storage.json]({{ site.baseurl }}/api/blueprints/integration/cloud-storage.json) |
