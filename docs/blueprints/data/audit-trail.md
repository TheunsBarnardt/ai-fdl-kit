...
| **YAML Source** | [View on GitHub](https://github.com/TheunsBarnardt/claude-fdl/blob/master/blueprints/data/audit-trail.blueprint.yaml) |
| **JSON API** | [audit-trail.json]({{ site.baseurl }}/api/blueprints/data/audit-trail.json) |
