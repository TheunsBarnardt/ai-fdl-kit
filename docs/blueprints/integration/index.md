...
| [Audio Effects]({{ site.baseurl }}/blueprints/integration/audio-effects/) | Audio bus effects and signal processing | 1.0.0 |
| [Audio Playback]({{ site.baseurl }}/blueprints/integration/audio-playback/) | 2D and 3D audio stream playback | 1.0.0 |
...
| [Collision Shapes]({{ site.baseurl }}/blueprints/integration/collision-shapes/) | Primitive collision shapes for physics and raycasting | 1.0.0 |
...
| [Emv Card Reader]({{ site.baseurl }}/blueprints/integration/emv-card-reader/) | EMV card reader hardware SDK integration — chip, NFC contactless, and magnetic stripe with PIN entry and EMV kernel processing | 1.0.0 |
...
| [Gamepad Input]({{ site.baseurl }}/blueprints/integration/gamepad-input/) | Joystick/gamepad input and haptic feedback | 1.0.0 |
...
| [Joints Constraints]({{ site.baseurl }}/blueprints/integration/joints-constraints/) | 3D joint constraints connecting rigid bodies | 1.0.0 |
| [Keyboard Input]({{ site.baseurl }}/blueprints/integration/keyboard-input/) | Keyboard input capture and key state tracking | 1.0.0 |
| [Lighting System]({{ site.baseurl }}/blueprints/integration/lighting-system/) | Directional, point, and spot light rendering | 1.0.0 |
| [Market Data Ingestion]({{ site.baseurl }}/blueprints/integration/market-data-ingestion/) | In-house market data store ingesting from multiple vendor feeds via FIX/FAST, REST, and webhooks with normalized schema and dedupe | 1.0.0 |
| [Material System]({{ site.baseurl }}/blueprints/integration/material-system/) | Surface properties and shader material system | 1.0.0 |
| [Mesh Rendering]({{ site.baseurl }}/blueprints/integration/mesh-rendering/) | 3D mesh data structures and rendering | 1.0.0 |
| [Mouse Input]({{ site.baseurl }}/blueprints/integration/mouse-input/) | Mouse position, button, and motion tracking | 1.0.0 |
...
| [Palm Vein]({{ site.baseurl }}/blueprints/integration/palm-vein/) | USB palm vein scanner integration using SDPVUnifiedAPI — capture, ROI detection, enrollment, 1:N identification, and cache pool management | 2.0.0 |
...
| [Payments Gateway Api]({{ site.baseurl }}/blueprints/integration/payments-gateway-api/) | Central HTTP surface for all payment operations — thin-client terminals and admin consoles call this; PGW owns rail selection, EMV, fraud, refunds, disputes | 1.0.0 |
...
| [Peer To Peer Networking]({{ site.baseurl }}/blueprints/integration/peer-to-peer-networking/) | ENet-based multiplayer networking | 1.0.0 |
...
| [Quaternion Rotations]({{ site.baseurl }}/blueprints/integration/quaternion-rotations/) | Quaternion-based 3D rotations (gimbal-lock free) | 1.0.0 |
...
| [Rigid Body Physics 3d]({{ site.baseurl }}/blueprints/integration/rigid-body-physics-3d/) | 3D rigid body simulation with gravity and collision | 1.0.0 |
...
| [Texture System]({{ site.baseurl }}/blueprints/integration/texture-system/) | Texture loading, filtering, and addressing modes | 1.0.0 |
| [Touch Input]({{ site.baseurl }}/blueprints/integration/touch-input/) | Multi-touch and gesture input for mobile devices | 1.0.0 |
| [Transform Operations]({{ site.baseurl }}/blueprints/integration/transform-operations/) | 3D and 2D spatial transforms (position, rotation, scale) | 1.0.0 |
...
| [Websocket Communication]({{ site.baseurl }}/blueprints/integration/websocket-communication/) | WebSocket protocol for real-time communication | 1.0.0 |
