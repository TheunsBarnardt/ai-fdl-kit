...
#### Reliable Option Pricing Cash Flow Additivity
...
|--------|------------|----------|----------|
| price_call | `autonomous` | - | - |
| price_put | `autonomous` | - | - |
| arbitrage_bounds_violated | `autonomous` | - | - |
| invalid_factors | `autonomous` | - | - |
| invalid_underlying | `autonomous` | - | - |
