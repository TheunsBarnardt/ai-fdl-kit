...
- **Component Overrides Theme** — when a component specifies a theme override different from the global theme, then Component displays in its overridden theme while rest of page uses global theme. *(error: `THEME_OVERRIDE_SCOPE_LEAK`)*
