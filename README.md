...
_Last run: 2026-04-11 — 36 blueprints below the fitness threshold. Pick a row, paste the command into Claude Code, and `/fdl-auto-evolve` will re-score after extraction._
...
### 🟡 notification/device-alarm-notifications — 62/100  *(+14 from last extraction)*
**Weakest dimension:** `agi` (0/5)

⚠ Previous attempt: a previous attempt lifted score 48 → 62 but still below 75. Try next:

_No candidates mapped for `notification` + `agi`. Run `/fdl-recommend-discover device-alarm-notifications` to find some._

### 🟡 workflow/maintenance-reminders — 62/100  *(+13 from last extraction)*
**Weakest dimension:** `agi` (0/5)

⚠ Previous attempt: a previous attempt lifted score 49 → 62 but still below 75. Try next:

_No candidates mapped for `workflow` + `agi`. Run `/fdl-recommend-discover maintenance-reminders` to find some._
...
### 🟡 data/fuel-level-reporting — 63/100  *(+14 from last extraction)*
**Weakest dimension:** `agi` (0/5)

⚠ Previous attempt: `payloadcms/payload` lifted score 49 → 63 but still below 75. Try next:
...
### 🟡 data/driver-identification — 64/100  *(+14 from last extraction)*
**Weakest dimension:** `agi` (0/5)

⚠ Previous attempt: `payloadcms/payload` lifted score 50 → 64 but still below 75. Try next:
...
### 🟡 notification/device-power-alerts — 64/100  *(+14 from last extraction)*
**Weakest dimension:** `agi` (0/5)

⚠ Previous attempt: a previous attempt lifted score 50 → 64 but still below 75. Try next:

_No candidates mapped for `notification` + `agi`. Run `/fdl-recommend-discover device-power-alerts` to find some._

### 🟡 workflow/stop-detection — 64/100  *(+14 from last extraction)*
**Weakest dimension:** `agi` (0/5)

⚠ Previous attempt: a previous attempt lifted score 50 → 64 but still below 75. Try next:

_No candidates mapped for `workflow` + `agi`. Run `/fdl-recommend-discover stop-detection` to find some._
...
### 🟡 data/engine-hours-tracking — 66/100  *(+14 from last extraction)*
**Weakest dimension:** `agi` (0/5)

⚠ Previous attempt: `payloadcms/payload` lifted score 52 → 66 but still below 75. Try next:
...
### 🟡 data/odometer-tracking — 66/100  *(+14 from last extraction)*
**Weakest dimension:** `agi` (0/5)
...
### 🟡 notification/geofence-alerts — 66/100  *(+8 from last extraction)*
**Weakest dimension:** `agi` (0/5)

⚠ Previous attempt: a previous attempt lifted score 58 → 66 but still below 75. Try next:

_No candidates mapped for `notification` + `agi`. Run `/fdl-recommend-discover geofence-alerts` to find some._
...
### 🟡 data/device-status-tracking — 68/100  *(+8 from last extraction)*
**Weakest dimension:** `agi` (0/5)

⚠ Previous attempt: `payloadcms/payload` lifted score 60 → 68 but still below 75. Try next:
...
### 🟡 notification/overspeed-alerts — 68/100  *(+8 from last extraction)*
**Weakest dimension:** `agi` (0/5)

⚠ Previous attempt: a previous attempt lifted score 60 → 68 but still below 75. Try next:

_No candidates mapped for `notification` + `agi`. Run `/fdl-recommend-discover overspeed-alerts` to find some._
...
### 🟡 workflow/trip-detection — 68/100  *(+14 from last extraction)*
**Weakest dimension:** `agi` (0/5)

⚠ Previous attempt: a previous attempt lifted score 54 → 68 but still below 75. Try next:

_No candidates mapped for `workflow` + `agi`. Run `/fdl-recommend-discover trip-detection` to find some._

### 🟡 data/ignition-detection — 69/100  *(+8 from last extraction)*
**Weakest dimension:** `agi` (0/5)

⚠ Previous attempt: `payloadcms/payload` lifted score 61 → 69 but still below 75. Try next:
...
### 🟡 access/fleet-device-sharing — 71/100  *(+14 from last extraction)*
**Weakest dimension:** `agi` (0/5)

⚠ Previous attempt: `openfga/openfga` lifted score 57 → 71 but still below 75. Try next:

- **cerbos/cerbos** — Canonical modern authorization reference
  ```
  /fdl-extract-code https://github.com/cerbos/cerbos fleet-device-sharing access
  ```
- **openfga/openfga** — Canonical fine-grained authorization reference
  ```
  /fdl-extract-code https://github.com/openfga/openfga fleet-device-sharing access
  ```

### 🟡 integration/remote-device-commands — 72/100  *(+8 from last extraction)*
**Weakest dimension:** `agi` (0/5)

⚠ Previous attempt: `ory/hydra` lifted score 64 → 72 but still below 75. Try next:
