...
- **Resolve Data On Context Change** — when component has a resolveData lifecycle hook defined; trigger event occurs: insert, replace, move, load, or force, then Component data updated with dynamically computed values.
