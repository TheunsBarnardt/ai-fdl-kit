---
title: "Chp Request To Pay Blueprint"
layout: default
parent: "Integration"
grand_parent: Blueprint Catalog
description: "PayShap Request-To-Pay (RTP) and refunds for Electrum Clearing House Payments — outbound/inbound RTP initiation, cancellation, and refund processing via the ZA_"
---

# Chp Request To Pay Blueprint

> PayShap Request-To-Pay (RTP) and refunds for Electrum Clearing House Payments — outbound/inbound RTP initiation, cancellation, and refund processing via the ZA_RPP scheme
...
| **Version** | 1.0.0 |
| **Tags** | payshap, rtp, request-to-pay, refund, payments, clearing-house, electrum, za-rpp, south-africa |
...
| **JSON API** | [chp-request-to-pay.json]({{ site.baseurl }}/api/blueprints/integration/chp-request-to-pay.json) |
...
| `electrum` | Electrum Platform | external | Electrum Clearing House Payments platform that orchestrates RTP messaging |
| `bankservafrica` | BankservAfrica | external | PayShap scheme operator managing the ZA_RPP real-time payments network |
...
<script type="application/ld+json">
{
  ...
  "name": "Chp Request To Pay Blueprint",
  "description": "PayShap Request-To-Pay (RTP) and refunds for Electrum Clearing House Payments — outbound/inbound RTP initiation, cancellation, and refund processing via the ZA_",
  "programmingLanguage": "YAML",
  "codeRepository": "https://github.com/TheunsBarnardt/claude-fdl",
  "license": "https://opensource.org/licenses/MIT",
  "keywords": "payshap, rtp, request-to-pay, refund, payments, clearing-house, electrum, za-rpp, south-africa"
}
</script>
