---
title: "Blockradar Api Blueprint"
layout: default
parent: "Integration"
grand_parent: Blueprint Catalog
description: "Blockradar stablecoin wallet infrastructure API — multi-chain wallets, addresses, deposits, withdrawals, swaps, gateway, checkout, and fiat offramp. 34 fields. "
---

# Blockradar Api Blueprint

> Blockradar stablecoin wallet infrastructure API — multi-chain wallets, addresses, deposits, withdrawals, swaps, gateway, checkout, and fiat offramp

| | |
|---|---|
| **Feature** | `blockradar-api` |
| **Category** | Integration |
| **Version** | 1.0.0 |
| **Tags** | blockchain, stablecoin, crypto, wallet, api, payments, usdc, usdt, defi, fintech |
...
| **JSON API** | [blockradar-api.json]({{ site.baseurl }}/api/blueprints/integration/blockradar-api.json) |
...
| `blockradar` | Blockradar Platform | external | Stablecoin wallet infrastructure that orchestrates multi-chain operations |
...
<script type="application/ld+json">
{
  ...
  "name": "Blockradar Api Blueprint",
  "description": "Blockradar stablecoin wallet infrastructure API — multi-chain wallets, addresses, deposits, withdrawals, swaps, gateway, checkout, and fiat offramp. 34 fields. ",
  "programmingLanguage": "YAML",
  "codeRepository": "https://github.com/TheunsBarnardt/claude-fdl",
  "license": "https://opensource.org/licenses/MIT",
  "keywords": "blockchain, stablecoin, crypto, wallet, api, payments, usdc, usdt, defi, fintech"
}
</script>
