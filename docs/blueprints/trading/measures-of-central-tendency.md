...
|--------|------------|----------|----------|
| compute_mean | `autonomous` | - | - |
| compute_weighted_mean | `autonomous` | - | - |
| compute_median | `autonomous` | - | - |
| compute_mode | `autonomous` | - | - |
| compute_trimmed | `autonomous` | - | - |
| compute_winsorized | `autonomous` | - | - |
| empty_observations | `autonomous` | - | - |
| invalid_weights | `autonomous` | - | - |
