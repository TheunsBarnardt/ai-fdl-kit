...
- **Rate Limit Warning** — when Request count has reached 80% of limit; But not yet at the limit, then allow request but emit warning event for monitoring. *(error: `RATE_LIMIT_CONFIG_INVALID`)*
