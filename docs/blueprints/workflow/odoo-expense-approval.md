---
title: "Odoo Expense Approval Blueprint"
layout: default
parent: "Workflow"
...
# Odoo Expense Approval Blueprint
...
| **JSON API** | [odoo-expense-approval.json]({{ site.baseurl }}/api/blueprints/workflow/odoo-expense-approval.json) |
...
<script type="application/ld+json">
{
  ...
  "name": "Odoo Expense Approval Blueprint",
  "description": "Employee expense submission and approval workflow with multi-level authorization, reimbursement tracking, accounting journal entry generation, and payment proce",
