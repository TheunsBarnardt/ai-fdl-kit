...
- **Message Dead Lettered** — when retry_count gte "max_retries"; dead_letter_queue exists, then Message moved to dead-letter queue with full retry history for investigation.
