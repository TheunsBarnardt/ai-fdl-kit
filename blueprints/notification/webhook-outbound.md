...
- **Webhook Failed** — when Endpoint returned 4xx or 5xx error OR Connection timeout or network error, then log failure, increment counter, and schedule retry with exponential backoff.
