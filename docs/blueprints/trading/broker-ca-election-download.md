...
#### Reliable Broker Ca Election Download
...
|--------|------------|----------|----------|
| download_election_frozen_file | `autonomous` | - | - |
| deliver_via_email | `autonomous` | - | - |
| deliver_via_sftp | `autonomous` | - | - |
| election_deadline_reminder | `autonomous` | - | - |
| default_election_application | `autonomous` | - | - |
| reject_after_cutoff | `supervised` | - | - |
