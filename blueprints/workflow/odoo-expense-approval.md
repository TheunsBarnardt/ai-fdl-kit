...
- **Expense Posted** — when expense is approved; accountant posts to accounting, then Expense recorded in accounting, payment can proceed. *(error: `EXPENSE_ALREADY_POSTED`)*
