...
- **Verify Backup Code Success** — when backup_code exists; Backup code matches a stored hash, then MFA verification successful via backup code — warn user about remaining codes.
