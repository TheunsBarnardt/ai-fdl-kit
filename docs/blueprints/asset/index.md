...
| [Fleet Vehicle Registry]({{ site.baseurl }}/blueprints/asset/fleet-vehicle-registry/) | Registry of fleets and vehicles within an organization, including fleet grouping, vehicle assignment to drivers, and vehicle type management. | 1.0.0 |
