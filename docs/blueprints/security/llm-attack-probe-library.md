...
**Then:**
- **create_record** target: `probe_attempt` — Records prompt, response, detector name, score, and fail verdict.
...
**Then:**
- **create_record** target: `probe_attempt` — Records prompt, response, detector name, score, and pass verdict.
