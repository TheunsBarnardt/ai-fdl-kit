...
- **Item Added To Cart** — when customer adds a product to cart; product is in stock; requested quantity is available, then Item added to cart, subtotal updated, stock reserved for 15 minutes.
