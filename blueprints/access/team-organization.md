...
- **Invite Accepted** — when Valid invite token provided; Invitation is still pending; Invitation has not expired (72-hour window), then user added to the organization with the assigned role.
