...
_Last run: 2026-04-12 — 53 blueprints below the fitness threshold. Pick a row, paste the command into Claude Code, and `/fdl-auto-evolve` will re-score after extraction._
...
### 🟡 notification/device-alarm-notifications — 64/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 1 of 1 codes unbound

⚠ Previous attempt: a previous attempt lifted score 62 → 64 but still below 75. Try next:
...
### 🟡 workflow/maintenance-reminders — 64/100  *(+2 from last extraction)*
...
### 🟡 asset/trip-replay — 65/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 1 of 1 codes unbound
...
### 🟡 data/fuel-level-reporting — 65/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 1 of 1 codes unbound

⚠ Previous attempt: `payloadcms/payload` lifted score 63 → 65 but still below 75. Try next:
...
### 🟡 asset/location-visit-history — 66/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 1 of 1 codes unbound
...
### 🟡 data/driver-identification — 66/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 2 of 2 codes unbound

⚠ Previous attempt: `payloadcms/payload` lifted score 64 → 66 but still below 75. Try next:
...
### 🟡 notification/device-power-alerts — 66/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 1 of 1 codes unbound
...
### 🟡 workflow/stop-detection — 66/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 1 of 1 codes unbound
...
### 🟡 asset/vehicle-efficiency-metrics — 68/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 1 of 1 codes unbound

⚠ Previous attempt: a previous attempt lifted score 66 → 68 but still below 75. Try next:

_No candidates mapped for `asset` + `error_binding`. Run `/fdl-recommend-discover vehicle-efficiency-metrics` to find some._

### 🟡 data/engine-hours-tracking — 68/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 1 of 1 codes unbound

⚠ Previous attempt: `payloadcms/payload` lifted score 66 → 68 but still below 75. Try next:
...
### 🟡 data/odometer-tracking — 68/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 1 of 1 codes unbound
...
### 🟡 notification/geofence-alerts — 68/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 1 of 1 codes unbound
...
### 🟡 asset/trip-energy-consumption — 69/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 1 of 1 codes unbound

⚠ Previous attempt: a previous attempt lifted score 67 → 69 but still below 75. Try next:

_No candidates mapped for `asset` + `error_binding`. Run `/fdl-recommend-discover trip-energy-consumption` to find some._

### 🟡 asset/vehicle-sleep-wake-detection — 69/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 1 of 1 codes unbound
...
### 🟡 asset/vehicle-state-machine — 69/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 2 of 2 codes unbound
...
### 🟡 data/device-status-tracking — 70/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 1 of 1 codes unbound

⚠ Previous attempt: `payloadcms/payload` lifted score 68 → 70 but still below 75. Try next:
...
### 🟡 notification/overspeed-alerts — 70/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 1 of 1 codes unbound
...
### 🟡 workflow/trip-detection — 70/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 1 of 1 codes unbound
...
### 🟡 workflow/workshop-directory — 70/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 3 of 3 codes unbound
...
### 🟡 asset/ev-charging-session — 71/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 1 of 1 codes unbound
...
### 🟡 data/ignition-detection — 71/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 1 of 1 codes unbound

⚠ Previous attempt: `payloadcms/payload` lifted score 69 → 71 but still below 75. Try next:
...
### 🟡 notification/vehicle-renewal-reminders — 71/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 2 of 2 codes unbound
...
### 🟡 security/prompt-attack-augmentation — 71/100  *(+4 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 2 of 2 codes unbound

⚠ Previous attempt: a previous attempt lifted score 67 → 71 but still below 75. Try next:

_No candidates mapped for `security` + `error_binding`. Run `/fdl-recommend-discover prompt-attack-augmentation` to find some._

### 🟡 workflow/order-sla-eta — 71/100  *(+2 from last extraction)*
**Weakest dimension:** `error_binding` (2/10) — 2 of 2 codes unbound
...
### 🟡 integration/remote-device-commands — 74/100  *(+2 from last extraction)*
**Weakest dimension:** `structure` (3/10)

⚠ Previous attempt: `ory/hydra` lifted score 72 → 74 but still below 75. Try next:
